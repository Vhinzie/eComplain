...
// Get complaints assigned to technician role
$complaints = [];
$complaint_result = get_complaints_for_role('technician');
if ($complaint_result) {
...
<head>
    ...
    <title>Technician Dashboard - ACLC eComplain</title>
...
<body>
    <header class="header">
        <h1>ACLC eComplain - Technician Dashboard</h1>
    </header>
    ...
    <div class="container">
        <div class="card">
            ...
            <div style="background: var(--accent); color: white; padding: 15px; border-radius: 6px; margin-bottom: 20px;">
                <h3 style="margin:0 0 6px; color: white;">Technical Support Portal</h3>
                <p style="margin:0; font-size: 0.95em;">Manage and respond to technical and equipment-related complaints.</p>
            </div>
        </div>
