...
if (!isset($_SESSION['user']) || $_SESSION['user']['role'] !== 'ssc') {
...
// Get complaints assigned to SSC role
$complaints = [];
$complaint_result = get_complaints_for_role('ssc');
if ($complaint_result) {
...
<head>
    ...
    <title>SSC Dashboard - ACLC eComplain</title>
...
<body>
    <header class="header">
        <h1>ACLC eComplain - SSC Dashboard</h1>
    </header>
    ...
    <div class="container">
        <div class="card">
            ...
            <div style="background: var(--accent); color: white; padding: 15px; border-radius: 6px; margin-bottom: 20px;">
                <h3 style="margin:0 0 6px; color: white;">Supreme Student Council Portal</h3>
                <p style="margin:0; font-size: 0.95em;">Manage and respond to student service-related complaints.</p>
            </div>
        </div>
