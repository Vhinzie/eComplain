...
if (!isset($_SESSION['user']) || $_SESSION['user']['role'] !== 'guard') {
...
// Get complaints assigned to guard role
$complaints = [];
$complaint_result = get_complaints_for_role('guard');
if ($complaint_result) {
...
<head>
    ...
    <title>Guard Dashboard - ACLC eComplain</title>
    ...
    <style>
        ...
        .status-resolved { background: #28a745; color: #08361a; }
...
<body>
    <header class="header">
        <h1>ACLC eComplain - Guard Dashboard</h1>
    </header>
    ...
    <div class="container">
        <div class="card">
            ...
            <div style="background: var(--accent); color: white; padding: 15px; border-radius: 6px; margin-bottom: 20px;">
                <h3 style="margin:0 0 6px; color: white;">Security Management Portal</h3>
                <p style="margin:0; font-size: 0.95em;">Monitor and respond to security-related complaints and incidents.</p>
            </div>
        </div>
