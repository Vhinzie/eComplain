...
if (!isset($_SESSION['user']) || $_SESSION['user']['role'] !== 'custodian') {
...
$complaints = [];
$complaint_result = get_complaints_for_role('custodian');
if ($complaint_result) {
...
<head>
    ...
    <title>Custodian Dashboard - ACLC eComplain</title>
...
<body>
    <header class="header">
        <h1>ACLC eComplain - Custodian Dashboard</h1>
    </header>
    ...
    <div class="container">
        <div class="card">
            ...
            <div style="background: var(--accent); color: white; padding: 15px; border-radius: 6px; margin-bottom: 20px;">
                <h3 style="margin:0 0 6px; color: white;">Facilities Management Portal</h3>
                <p style="margin:0; font-size: 0.95em;">Track and manage maintenance and cleanliness-related complaints.</p>
            </div>
        </div>
